...
// Windows implementation of IPC using named pipes
// Listens on a named pipe and returns a handle for communication
vw_ipc_handle_t* vw_ipc_listen(const char* endpoint_name);
// Connects to a named pipe and returns a handle for communication
