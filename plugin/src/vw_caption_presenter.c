...
static bool vw_caption_presenter_render_spu(vout_thread_t* vout, int channel_id, const char* text, int alignment,
                                             int y, int64_t start_tick, int64_t stop_tick, bool replace_existing,
                                             bool persistent) {
...
static bool vw_caption_presenter_render_internal(vw_caption_presenter_t* presenter,
                                                  const vw_caption_segment_t* segment, int64_t duration_us,
