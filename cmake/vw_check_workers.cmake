...
if(NOT DEFINED LUA_SETTINGS_PATH OR NOT EXISTS "${LUA_SETTINGS_PATH}")
  message(FATAL_ERROR "Generated Lua settings extension not found: '${LUA_SETTINGS_PATH}'")
endif()
...
file(COPY "${SOURCE_ROOT}/lua/" DESTINATION "${STAGE_DIR}/lua"
     PATTERN "extensions/vlc_whisper_settings.lua" EXCLUDE)
file(COPY "${LUA_SETTINGS_PATH}" DESTINATION "${STAGE_DIR}/lua/extensions")
