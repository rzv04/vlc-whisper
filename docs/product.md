...
- Translation, bilingual captions, speaker labels, subtitle-file export, editing, search, automatic language selection, updates, accounts, analytics, DRM bypass, and accessibility certification.
- A second settings dialog, translation, multiple simultaneous VLC instances, network streams, IPTV, VOD, livestreams, or accessibility certification.
