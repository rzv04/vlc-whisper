...
- `tests/unit/test_benchmark.c`: Stable per-user last-session reporting, unique snapshot staging, dot-decimal v2 timing fields, privacy-safe translation failure diagnostics, and live-clock reset preservation.
