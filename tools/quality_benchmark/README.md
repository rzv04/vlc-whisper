...
Headless on Windows x64/Linux x64: no VLC GUI/process, audio output, X11/Wayland, or desktop environment. Use a developer/test build (`BUILD_TESTING=ON`). Corpus/results stay under ignored `tools/quality_benchmark/local/`.
